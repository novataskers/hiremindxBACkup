...
export function CommunityOnboardingModal({
  ...
  const [step, setStep] = useState<"select" | "profile" | "portfolio" | "complete">("select");
  ...
  const stepNumber = step === "select" ? 1 : step === "profile" ? 2 : step === "portfolio" ? 3 : 4;
  const totalSteps = userType === "freelancer" ? 4 : 3;
