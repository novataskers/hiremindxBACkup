...
export default function Messages() {
  ...
  const selectedStatus = selectedConversationData?.status ?? "offline";
  const isSelectedOnline = selectedStatus === "online";
                      ...
                      <div className="flex items-start gap-3">
                        <div className="relative">
                          ...
                          <span
                            ...
                            aria-label={`${conv.name} is ${conv.status}`}
                            title={conv.status}
                          />
                        </div>
              ...
              <div className="mb-4 pb-4 border-b border-border flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div className="relative">
                    ...
                    <span
                      className={`absolute -bottom-0.5 -right-0.5 h-3 w-3 rounded-full border-2 border-background ${
                        isSelectedOnline ? "bg-emerald-500" : "bg-slate-400"
                      }`}
                      aria-label={`${selectedConversationData?.name} is ${selectedStatus}`}
